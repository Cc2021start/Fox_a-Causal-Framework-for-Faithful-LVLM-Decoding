...
class MiniGPT4(Blip2Base):
    ...
    def __init__(
        ...
        q_former_model="/home/kdzlys/sid2/model/blip2_pretrained_flant5xxl.pth",
        img_size=224,
        drop_path_rate=0,
    ...
    def generate(
        ...
        if flag == None:
            ...
            img_embeds_cd, atts_img_cd = self.encode_img(images_cd)
            images_cd, _, _ = self.prompt_wrap(img_embeds_cd, atts_img_cd, instruction)
        ...
        with self.maybe_autocast():
            ...
            if flag == None:
                ...
                images_cd = torch.cat([bos_embeds, images_cd], dim=1)
            # 
            # images_cd = torch.zeros(images_cd.shape).cuda().half()
            # 
            attention_mask = torch.cat([atts_bos, attention_mask], dim=1)
    ...
    def from_config(cls, cfg):
        ...
        q_former_model = cfg.get("q_former_model", "/home/kdzlys/sid2/model/blip2_pretrained_flant5xxl.pth")
